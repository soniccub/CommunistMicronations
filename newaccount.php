<DOCTYPE html>
<!--This is the login page they must login or finish the test and create an account to get past this -->
...
<form>
  ...
  <input type="radio" name="q1" value="0"> None of the above. <br>
...
<br><br>
  ...
  <input type="radio" name="q2" value="-1"> What is Communism? <br>
...
<br><br>
  ...
  <input type="radio" name="q4" value="1"> None of the above. <br>
...
<br><br>
  ...
  <input type="radio" name="q5" value="0"> To make the powerful more money <br>
...
<br><br>
  ...
  <input type="radio" name="q6" value="1"> both 2 and 3. <br>
